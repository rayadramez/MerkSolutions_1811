...
{
	public partial class VisitTiming_Pupillary : DBCommon, IDBCommon, IPEMR_Element
	{
		MerkFinanceEntities _context;
		private static List<VisitTiming_Pupillary> _items;
		public static List<VisitTiming_Pupillary> ItemsList = new List<VisitTiming_Pupillary>();
		...
		public override bool LoadItemsList()
		{
			...
			ItemsList = DBContext_External.VisitTiming_Pupillary.ToList();
			return true;
		}

		public int TableIdentityID
		{
			get { return (int)DB_TableIdentity.VisitTiming_Pupillary; }
		}
		...
		{
			get { return "VisitTiming_Pupillary"; }
		}

		public IDBCommon GetSpecificEntity(MerkFinanceEntities context, int id)
		{
			return context.VisitTiming_Pupillary.FirstOrDefault(item => item.ID.Equals(id));
		}
