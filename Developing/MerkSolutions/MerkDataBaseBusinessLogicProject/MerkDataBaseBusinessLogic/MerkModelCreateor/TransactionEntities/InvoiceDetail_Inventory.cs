...
{
	public partial class InvoiceDetail_Inventory : DBCommon, IDBCommon, IInvoiceItem
	{
		MerkFinanceEntities _context;
		private static List<InvoiceDetail_Inventory> _items;
		public static List<InvoiceDetail_Inventory> ItemsList = new List<InvoiceDetail_Inventory>();
		public static List<InvoiceDetail_Inventory> AllItemsList = new List<InvoiceDetail_Inventory>();
		...
		public override bool LoadItemsList()
		{
			...
			ItemsList = AllItemsList = DBContext_External.InvoiceDetail_Inventory.ToList();
			return true;
		}

		public int TableIdentityID
		{
			get { return (int)DB_TableIdentity.InvoiceDetail_Inventory; }
		}
		...
		{
			get { return InvoiceItemType.InvoiceDetail_Inventory; }
		}
