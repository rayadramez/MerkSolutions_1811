...
{
	public partial class VisitTiming_LabResult : DBCommon, IDBCommon, IPEMR_Element
	{
		MerkFinanceEntities _context;
		private static List<VisitTiming_LabResult> _items;
		public static List<VisitTiming_LabResult> ItemsList = new List<VisitTiming_LabResult>();
		...
		public override bool LoadItemsList()
		{
			...
			ItemsList = DBContext_External.VisitTiming_LabResult.ToList();
			return true;
		}

		public int TableIdentityID
		{
			get { return (int)DB_TableIdentity.VisitTiming_LabResult; }
		}
		...
		{
			get { return "VisitTiming_LabResult"; }
		}

		public IDBCommon GetSpecificEntity(MerkFinanceEntities context, int id)
		{
			return context.VisitTiming_LabResult.FirstOrDefault(item => item.ID.Equals(id));
		}
