...
{
	public partial class VisitTiming_SurgeryReservation : DBCommon, IDBCommon, IPEMR_Element
	{
		MerkFinanceEntities _context;
		private static List<VisitTiming_SurgeryReservation> _items;
		public static List<VisitTiming_SurgeryReservation> ItemsList = new List<VisitTiming_SurgeryReservation>();
		...
		public override bool LoadItemsList()
		{
			...
			ItemsList = DBContext_External.VisitTiming_SurgeryReservation.ToList();
			return true;
		}

		public int TableIdentityID
		{
			get { return (int)DB_TableIdentity.VisitTiming_SurgeryReservation; }
		}
		...
		public List<string> ChildrenItemsList
		{
			get
			{
				...
				list.Add("VisitTiming_LabResult");
				return list;
			}
		}
		...
		{
			get { return "VisitTiming_SurgeryReservation"; }
		}
