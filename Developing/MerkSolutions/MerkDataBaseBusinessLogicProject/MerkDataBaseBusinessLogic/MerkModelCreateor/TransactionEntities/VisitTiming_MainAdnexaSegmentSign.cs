...
{
	public partial class VisitTiming_MainAdnexaSegmentSign : DBCommon, IDBCommon, IPEMR_Element
	{
		MerkFinanceEntities _context;
		private static List<VisitTiming_MainAdnexaSegmentSign> _items;
		public static List<VisitTiming_MainAdnexaSegmentSign> ItemsList = new List<VisitTiming_MainAdnexaSegmentSign>();
		...
		public override bool LoadItemsList()
		{
			...
			ItemsList = DBContext_External.VisitTiming_MainAdnexaSegmentSign.ToList();
			return true;
		}

		public int TableIdentityID
		{
			get { return (int)DB_TableIdentity.VisitTiming_MainAdnexaSegmentSign; }
		}
		...
		{
			get { return "VisitTiming_MainAdnexaSegmentSign"; }
		}
		...
		public string ElementName
		{
			get
			{
				PEMR_Elemet_p element = PEMR_Elemet_p.ItemsList.Find(
					item => Convert.ToInt32(item.ID).Equals((int)DB_PEMR_ElementType.VisitTiming_MainAdnexaSegmentSign));
				if (element == null)
					return String.Empty;
