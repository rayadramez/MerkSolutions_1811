...
{
	public partial class VisitTiming_Diagnosis : DBCommon, IDBCommon, IPEMR_Element
	{
		MerkFinanceEntities _context;
		private static List<VisitTiming_Diagnosis> _items;
		public static List<VisitTiming_Diagnosis> ItemsList = new List<VisitTiming_Diagnosis>();
		...
		public override bool LoadItemsList()
		{
			...
			ItemsList = DBContext_External.VisitTiming_Diagnosis.ToList();
			return true;
		}

		public int TableIdentityID
		{
			get { return (int)DB_TableIdentity.VisitTiming_Diagnosis; }
		}
		...
		{
			get { return "VisitTiming_Diagnosis"; }
		}

		public IDBCommon GetSpecificEntity(MerkFinanceEntities context, int id)
		{
			return context.VisitTiming_Diagnosis.FirstOrDefault(item => item.ID.Equals(id));
		}
		...
		{
			get { return DB_PEMR_ElementType.VisitTiming_Diagnosis; }
		}
		...
		public Eye_p Eye
		{
			get
			{
				if(Eye_P_ID != null)
				{
					Eye_p type = Eye_p.ItemsList.Find(item =>
						Convert.ToInt32(item.ID).Equals(Convert.ToInt32(Eye_P_ID)));
					return type;
				}
		...
		public bool IsForOphthalmology
		{
			get { return Eye_P_ID != null; }
		}
	}
}
