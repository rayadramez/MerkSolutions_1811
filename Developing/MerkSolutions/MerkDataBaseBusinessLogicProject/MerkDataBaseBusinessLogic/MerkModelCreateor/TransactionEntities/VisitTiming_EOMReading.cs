...
{
	public partial class VisitTiming_EOMReading : DBCommon, IDBCommon, IPEMR_Element
	{
		MerkFinanceEntities _context;
		private static List<VisitTiming_EOMReading> _items;
		public static List<VisitTiming_EOMReading> ItemsList = new List<VisitTiming_EOMReading>();
		...
		public override bool LoadItemsList()
		{
			...
			ItemsList = DBContext_External.VisitTiming_EOMReading.ToList();
			return true;
		}

		public int TableIdentityID
		{
			get { return (int)DB_TableIdentity.VisitTiming_EOMReading; }
		}
		...
		{
			get { return "VisitTiming_EOMReading"; }
		}

		public IDBCommon GetSpecificEntity(MerkFinanceEntities context, int id)
		{
			return context.VisitTiming_EOMReading.FirstOrDefault(item => item.ID.Equals(id));
		}
