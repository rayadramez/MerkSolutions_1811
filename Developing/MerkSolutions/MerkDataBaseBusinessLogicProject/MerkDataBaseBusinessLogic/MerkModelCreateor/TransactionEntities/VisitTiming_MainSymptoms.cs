...
{
	public partial class VisitTiming_MainSymptoms : DBCommon, IDBCommon, IPEMR_Element
	{
		MerkFinanceEntities _context;
		private static List<VisitTiming_MainSymptoms> _items;
		public static List<VisitTiming_MainSymptoms> ItemsList = new List<VisitTiming_MainSymptoms>();
		...
		public override bool LoadItemsList()
		{
			...
			ItemsList = DBContext_External.VisitTiming_MainSymptoms.ToList();
			return true;
		}

		public int TableIdentityID
		{
			get { return (int)DB_TableIdentity.VisitTiming_MainSymptoms; }
		}
		...
		{
			get { return "VisitTiming_MainSymptoms"; }
		}

		public IDBCommon GetSpecificEntity(MerkFinanceEntities context, int id)
		{
			return context.VisitTiming_MainSymptoms.FirstOrDefault(item => item.ID.Equals(id));
		}
		...
		{
			get { return DB_PEMR_ElementType.VisitTiming_MainSymptoms; }
		}
