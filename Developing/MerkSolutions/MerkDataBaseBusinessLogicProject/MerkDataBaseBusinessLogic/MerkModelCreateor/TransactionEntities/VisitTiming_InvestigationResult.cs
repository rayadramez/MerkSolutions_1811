...
{
	public partial class VisitTiming_InvestigationResult : DBCommon, IDBCommon, IPEMR_Element
	{
		MerkFinanceEntities _context;
		private static List<VisitTiming_InvestigationResult> _items;
		public static List<VisitTiming_InvestigationResult> ItemsList = new List<VisitTiming_InvestigationResult>();
		...
		public override bool LoadItemsList()
		{
			...
			ItemsList = DBContext_External.VisitTiming_InvestigationResult.ToList();
			return true;
		}

		public int TableIdentityID
		{
			get { return (int)DB_TableIdentity.VisitTiming_InvestigationResult; }
		}
		...
		{
			get { return "VisitTiming_InvestigationResult"; }
		}

		public IDBCommon GetSpecificEntity(MerkFinanceEntities context, int id)
		{
			return context.VisitTiming_InvestigationResult.FirstOrDefault(item => item.ID.Equals(id));
		}
