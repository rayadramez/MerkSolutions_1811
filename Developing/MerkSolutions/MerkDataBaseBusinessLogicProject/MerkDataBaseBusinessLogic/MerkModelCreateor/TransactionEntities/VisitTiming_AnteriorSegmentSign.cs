...
{
	public partial class VisitTiming_AnteriorSegmentSign : DBCommon, IDBCommon, IPEMR_Element
	{
		MerkFinanceEntities _context;
		private static List<VisitTiming_AnteriorSegmentSign> _items;
		public static List<VisitTiming_AnteriorSegmentSign> ItemsList = new List<VisitTiming_AnteriorSegmentSign>();
		...
		public override bool LoadItemsList()
		{
			...
			ItemsList = DBContext_External.VisitTiming_AnteriorSegmentSign.ToList();
			return true;
		}

		public int TableIdentityID
		{
			get { return (int)DB_TableIdentity.VisitTiming_AnteriorSegmentSign; }
		}
		...
		{
			get { return "VisitTiming_AnteriorSegmentSign"; }
		}

		public IDBCommon GetSpecificEntity(MerkFinanceEntities context, int id)
		{
			return context.VisitTiming_AnteriorSegmentSign.FirstOrDefault(item => item.ID.Equals(id));
		}
			...
			get
			{
				...
				if (PEM_ElementPrintOrder_cu.ItemsList.Count == 0)
				{
					element = PEMR_Elemet_p.ItemsList.Find(
						item => Convert.ToInt32(item.ID).Equals((int)DB_PEMR_ElementType.VisitTiming_AnteriorSegmentSign));
					if (element != null)
				...
				PEM_ElementPrintOrder_cu elementPrintOrder = PEM_ElementPrintOrder_cu.ItemsList.Find(
					item => Convert.ToInt32(item.PEMR_Elemet_P_ID)
						.Equals((int)DB_PEMR_ElementType.VisitTiming_AnteriorSegmentSign));
