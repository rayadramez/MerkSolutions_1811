...
{
	public partial class VisitTiming_MainEOMSign : DBCommon, IDBCommon, IPEMR_Element
	{
		MerkFinanceEntities _context;
		private static List<VisitTiming_MainEOMSign> _items;
		public static List<VisitTiming_MainEOMSign> ItemsList = new List<VisitTiming_MainEOMSign>();
		...
		public override bool LoadItemsList()
		{
			...
			ItemsList = DBContext_External.VisitTiming_MainEOMSign.ToList();
			return true;
		}

		public int TableIdentityID
		{
			get { return (int)DB_TableIdentity.VisitTiming_MainEOMSign; }
		}
		...
		{
			get { return "VisitTiming_MainEOMSign"; }
		}

		public IDBCommon GetSpecificEntity(MerkFinanceEntities context, int id)
		{
			return context.VisitTiming_MainEOMSign.FirstOrDefault(item => item.ID.Equals(id));
		}
