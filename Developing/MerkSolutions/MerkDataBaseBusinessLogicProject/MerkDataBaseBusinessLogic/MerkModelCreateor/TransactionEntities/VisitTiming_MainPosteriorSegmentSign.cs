...
{
	public partial class VisitTiming_MainPosteriorSegmentSign : DBCommon, IDBCommon, IPEMR_Element
	{
		MerkFinanceEntities _context;
		private static List<VisitTiming_MainPosteriorSegmentSign> _items;
		public static List<VisitTiming_MainPosteriorSegmentSign> ItemsList = new List<VisitTiming_MainPosteriorSegmentSign>();
		...
		public override bool LoadItemsList()
		{
			...
			ItemsList = DBContext_External.VisitTiming_MainPosteriorSegmentSign.ToList();
			return true;
		}

		public int TableIdentityID
		{
			get { return (int)DB_TableIdentity.VisitTiming_MainPosteriorSegmentSign; }
		}
		...
		{
			get { return "VisitTiming_MainPosteriorSegmentSign"; }
		}

		public IDBCommon GetSpecificEntity(MerkFinanceEntities context, int id)
		{
			return context.VisitTiming_MainPosteriorSegmentSign.FirstOrDefault(item => item.ID.Equals(id));
		}
		...
		{
			get { return DB_PEMR_ElementType.VisitTiming_PosteriorSegmentSign; }
		}
			...
			get
			{
				...
				if (PEM_ElementPrintOrder_cu.ItemsList.Count == 0)
				{
					element = PEMR_Elemet_p.ItemsList.Find(
						item => Convert.ToInt32(item.ID).Equals((int)DB_PEMR_ElementType.VisitTiming_PosteriorSegmentSign));
					if (element != null)
				...
				PEM_ElementPrintOrder_cu elementPrintOrder = PEM_ElementPrintOrder_cu.ItemsList.Find(
					item => Convert.ToInt32(item.PEMR_Elemet_P_ID)
						.Equals((int)DB_PEMR_ElementType.VisitTiming_PosteriorSegmentSign));
