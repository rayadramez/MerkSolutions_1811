...
{
	public partial class VisitTiming_MainAnteriorSegmentSign : DBCommon, IDBCommon, IPEMR_Element
	{
		MerkFinanceEntities _context;
		private static List<VisitTiming_MainAnteriorSegmentSign> _items;
		public static List<VisitTiming_MainAnteriorSegmentSign> ItemsList = new List<VisitTiming_MainAnteriorSegmentSign>();
		...
		public override bool LoadItemsList()
		{
			...
			ItemsList = DBContext_External.VisitTiming_MainAnteriorSegmentSign.ToList();
			return true;
		}

		public int TableIdentityID
		{
			get { return (int)DB_TableIdentity.VisitTiming_MainAnteriorSegmentSign; }
		}
		...
		{
			get { return "VisitTiming_MainAnteriorSegmentSign"; }
		}

		public IDBCommon GetSpecificEntity(MerkFinanceEntities context, int id)
		{
			return context.VisitTiming_MainAnteriorSegmentSign.FirstOrDefault(item => item.ID.Equals(id));
		}
