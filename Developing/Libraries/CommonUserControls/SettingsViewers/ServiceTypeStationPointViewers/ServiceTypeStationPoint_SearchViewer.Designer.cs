...
{
	partial class ServiceTypeStationPoint_SearchViewer
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.layoutControl1.OptionsCustomizationForm.DesignTimeCustomizationFormPositionAndSize = new System.Drawing.Rectangle(171, 347, 250, 350);
			...
			// lkeStationPoint
			// 
			this.lkeStationPoint.Location = new System.Drawing.Point(396, 3);
			...
			this.chkInvestigation.TabIndex = 28;
			...
			this.chkExamination.TabIndex = 26;
			...
			this.layoutControlItem1.Text = "العيـــادة";
			this.layoutControlItem1.TextSize = new System.Drawing.Size(38, 13);
			// 
			// layoutControlItem2
			// 
			this.layoutControlItem2.Control = this.chkInvestigation;
			this.layoutControlItem2.Location = new System.Drawing.Point(488, 26);
			this.layoutControlItem2.Name = "layoutControlItem2";
			this.layoutControlItem2.Padding = new DevExpress.XtraLayout.Utils.Padding(0, 0, 0, 0);
			this.layoutControlItem2.Size = new System.Drawing.Size(126, 49);
			this.layoutControlItem2.Spacing = new DevExpress.XtraLayout.Utils.Padding(3, 3, 3, 3);
			this.layoutControlItem2.Text = "العيـــادة";
			this.layoutControlItem2.TextSize = new System.Drawing.Size(0, 0);
			this.layoutControlItem2.TextVisible = false;
			// 
			// layoutControlItem3
			// 
			this.layoutControlItem3.Control = this.chkExamination;
			this.layoutControlItem3.Location = new System.Drawing.Point(614, 26);
			this.layoutControlItem3.Name = "layoutControlItem3";
			this.layoutControlItem3.Padding = new DevExpress.XtraLayout.Utils.Padding(0, 0, 0, 0);
			this.layoutControlItem3.Size = new System.Drawing.Size(126, 49);
			this.layoutControlItem3.Spacing = new DevExpress.XtraLayout.Utils.Padding(3, 3, 3, 3);
			this.layoutControlItem3.Text = "العيـــادة";
			...
			this.layoutControlItem4.Text = "العيـــادة";
			...
			this.layoutControlItem5.Text = "العيـــادة";
			...
			// 
			// ServiceTypeStationPoint_SearchViewer
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.Controls.Add(this.layoutControl1);
			this.MinimumSize = new System.Drawing.Size(0, 75);
			this.Name = "ServiceTypeStationPoint_SearchViewer";
