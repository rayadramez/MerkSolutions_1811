...
{
	public partial class UnitMeasurment_EditorViewer : 
		//DevExpress.XtraEditors.XtraUserControl
		CommonAbstractEditorViewer<UnitMeasurment_cu>,
		IUnitMeasurmentViewer
	{
		public UnitMeasurment_EditorViewer()
		{
			InitializeComponent();

			CommonViewsActions.LoadXMLFromString(layoutControl1, Resources.LocalizedRes.lyt_UnitMeasurment_EditorViewer);
			CommonViewsActions.SetupSyle(this);
		}

		#region Overrides of CommonAbstractViewer<UnitMeasurment_cu>

		public override IMVCController<UnitMeasurment_cu> ViewerCollector { get; set; }
