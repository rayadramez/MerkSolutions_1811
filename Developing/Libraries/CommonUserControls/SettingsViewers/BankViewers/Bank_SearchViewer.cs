...
{
	public partial class Bank_SearchViewer : 
		//UserControl
		CommonAbstractSearchViewer<Bank_cu>,
		IBankViewer
	{
		private List<ChartOfAccount_cu> lastUsed = new List<ChartOfAccount_cu>();

		public Bank_SearchViewer()
		{
			InitializeComponent();
		}
		...
		{
			get { return Resources.LocalizedRes.grd_Bank_SearchViewer; }
		}
		...
		private void Bank_SearchViewer_Load(object sender, EventArgs e)
		{
			CommonViewsActions.LoadXMLFromString(layoutControl1, Resources.LocalizedRes.lyt_Bank_SearchViewer);
