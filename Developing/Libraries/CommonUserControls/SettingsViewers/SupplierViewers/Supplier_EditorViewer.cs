...
{
	public partial class Supplier_EditorViewer : 
		//DevExpress.XtraEditors.XtraUserControl
		CommonAbstractEditorViewer<Supplier_cu>,
		ISupplierViewer
	{
		public Supplier_EditorViewer()
		{
			InitializeComponent();

			CommonViewsActions.LoadXMLFromString(layoutControl1, Resources.LocalizedRes.lyt_Supplier_EditorViewer);
		...
		public override IMVCController<Supplier_cu> ViewerCollector { get; set; }

		public override object ViewerID
		{
			get { return (int)ViewerName.Supplier_Viewer; }
		}

		public override string HeaderTitle
		{
			get { return "المـورديــــن"; }
		}
