...
{
	partial class PEMR_LabContainer
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(PEMR_LabContainer));
			this.layoutControl1 = new DevExpress.XtraLayout.LayoutControl();
			this.tabMainLab = new DevExpress.XtraTab.XtraTabControl();
			...
			((System.ComponentModel.ISupportInitialize)(this.tabMainLab)).BeginInit();
			this.tabMainLab.SuspendLayout();
			...
			// layoutControl1
			// 
			this.layoutControl1.Controls.Add(this.tabMainLab);
			...
			// tabMainLab
			// 
			this.tabMainLab.Appearance.BackColor = System.Drawing.Color.DimGray;
			this.tabMainLab.Appearance.Options.UseBackColor = true;
			this.tabMainLab.BorderStyle = DevExpress.XtraEditors.Controls.BorderStyles.Simple;
			this.tabMainLab.HeaderAutoFill = DevExpress.Utils.DefaultBoolean.True;
			this.tabMainLab.Location = new System.Drawing.Point(0, 47);
			this.tabMainLab.Name = "tabMainLab";
			this.tabMainLab.SelectedTabPage = this.tabReservation;
			this.tabMainLab.Size = new System.Drawing.Size(972, 497);
			this.tabMainLab.TabIndex = 12;
			this.tabMainLab.TabPages.AddRange(new DevExpress.XtraTab.XtraTabPage[] {
            this.tabResults,
            this.tabReservation});
			this.tabMainLab.SelectedPageChanged += new DevExpress.XtraTab.TabPageChangedEventHandler(this.tabMainLab_SelectedPageChanged);
			// 
			// tabReservation
			// 
			...
			this.tabReservation.Text = "Request Lab";
			// 
			// layoutControl2
			// 
			...
			this.layoutControlItem9.Text = "Lab Category";
			...
			this.layoutControlItem10.Text = "Lab";
			...
			this.tabResults.Text = "Lab Results";
			// 
			// layoutControl3
			// 
			...
			this.layoutControlItem18.Text = "Lab";
			...
			this.btnAddedDiagnosisFullScreen.TabIndex = 43;
			...
			// pictureEdit1
			// 
			this.pictureEdit1.EditValue = global::CommonUserControls.Properties.Resources.LabsIcon_16_01;
			...
			// layoutControlItem20
			// 
			this.layoutControlItem20.Control = this.tabMainLab;
			...
			this.Name = "PEMR_LabContainer";
			this.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
			this.Size = new System.Drawing.Size(972, 544);
			((System.ComponentModel.ISupportInitialize)(this.layoutControl1)).EndInit();
			this.layoutControl1.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.tabMainLab)).EndInit();
			this.tabMainLab.ResumeLayout(false);
		...
		private DevExpress.XtraTab.XtraTabControl tabMainLab;
